    ...
    <section className="bg-[#050505] text-[#F5F5F5] py-12 md:py-20 px-4 md:px-8 w-full border-t border-b border-white/10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 flex justify-center">
          <RouterLink
            to="/work"
            className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full border border-white/20 bg-white/[0.03] text-sm font-mono text-white tracking-widest uppercase hover:bg-white/10 hover:border-white/50 transition-all duration-300 shadow-lg"
          >
