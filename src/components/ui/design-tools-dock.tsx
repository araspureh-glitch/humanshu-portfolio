...
const toolsData: ToolItem[] = [
  ...
  },
  {
    ...
    borderColor: "#EC4899",
    icon: (isHovered) => (
      <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6 transition-all duration-300" fill={isHovered ? "url(#agGradMacroTs)" : "#E0E0E0"}>
        <path d="M12 3L2 19h4.5l2.2-4h6.6l2.2 4H22L12 3zm0 4.5l2.3 4.2H9.7L12 7.5z" />
        <defs>
          <linearGradient id="agGradMacroTs" x1="0%" y1="0%" x2="100%" y2="100%">
