...
// --- 8 Tools with Monochrome Default & Full Brand Color Reveal on Hover ---
const toolsData = [
  {
    id: "figma",
    name: "Figma",
  ...
  },
  {
    ...
    icon: (isHovered) => (
      <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6 transition-all duration-300" fill={isHovered ? "url(#agGrad3d)" : "#999999"}>
        <path d="M12 3L2 19h4.5l2.2-4h6.6l2.2 4H22L12 3zm0 4.5l2.3 4.2H9.7L12 7.5z" />
        <defs>
          <linearGradient id="agGrad3d" x1="0%" y1="0%" x2="100%" y2="100%">
...
export function DesignToolsDock() {
  ...
  return (
    <section className="w-full bg-[#050505] text-[#F5F5F5] py-16 px-4 sm:px-8 flex items-center justify-center relative z-20 overflow-visible">
      ...
      {/* 3D Camera Perspective Wrapper (Low Side-Perspective View looking from front-right) */}
      <div 
      ...
      >
        ...
        {/* Outer 3D Glass Dock Bar with Perspective Rotation */}
        <div 
        ...
        >
          ...
          {/* Front Glass Edge Thickness / Rim for Low Side-Angle Realism */}
          <div 
          ...
          >
            ...
            {toolsData.map((tool, index) => {
              ...
              // Neighbor Magnetic Displacement (3-4px outward)
              let neighborShift = 0;
              ...
              return (
                <div key={tool.id} className="relative flex flex-col items-center" style={{ transformStyle: "preserve-3d" }}>
                  ...
                  {/* 3D Physical Key Button with Click Press Animation */}
                  <motion.button
